...
class ArrayNormaliser():
    ...
    def fit_traps(self,iteration=0,plot=False):
        ...
        new_start_amps = self.trap_df['start_amp_{}'.format(iteration)]*(self.trap_df['multi_0_I0'].mean()/self.trap_df['multi_{}_I0'.format(iteration)])**self.scale_index
