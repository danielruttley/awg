...
frequencies = np.linspace(90,255,301)
# frequencies = np.linspace(160,200,11)
shuffle(frequencies)

with open(r"DE_base_params_AWG1.awg") as f:
    params = json.load(f)
    # print(d)
...
with open(r"DE_params_AWG1.awg", 'w', encoding='utf-8') as f:
    json.dump(params, f, ensure_ascii=False, indent=4)
    
np.savetxt(r"DE_freqs_AWG1.csv", frequencies, delimiter=",")
