...
frequencies = np.linspace(60,100,301)
...
params['card_settings']['max_output_mV'] = 2000 # need more power for this amplifier
...
with open(r"DE_params_AWG3_servo_AOM.awg", 'w', encoding='utf-8') as f:
    json.dump(params, f, ensure_ascii=False, indent=4)
    
np.savetxt(r"DE_freqs_AWG3_servo_AOM.csv", frequencies, delimiter=",")
